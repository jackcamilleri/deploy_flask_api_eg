...
@app.route("/")
def index():
    return "welcome playa! the endpoints for data are '/atom' and '/multiply'"
...
#put the command below in a seperate python file 
...
@app.route("/<name>")
def greet(name):
    return f"hello {name}! you're a cool person"
